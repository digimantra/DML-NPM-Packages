  ...
  return (
    <div className="w-72 h-auto px-4 bg-[#fafbff] shadow-lg rounded-lg">
      ...
      <div className="flex items-center justify-between py-3.5 px-4">
        ...
        <div  className="text-[12px] font-normal leading-[14px] text-[#e11d07]">Mark all as read</div>
      </div>
      ...
      {visibleData?.map((el)=>(
 <div key={data?.id} className="flex items-start gap-2 p-4 border-b-2 border-[#d0d5dd]">
