...
export const Actions = ({ show, setShow, list, customButton, position }) => {
  {
    /*Handle action*/
  }

  const handleItemClick = (action) => {
    // Invoke the action function when the item is clicked

    action();

    // Optionally, close the menu after the action is performed
    setShow(false);
  };
  ...
  return (
    <div className="relative font-sans inline-block text-left">
      {/* Imported button component through prop */}
      <div
